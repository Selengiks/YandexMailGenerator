...
class AdminLayer:
    ...
    async def help(self: types.Message):
        result = f"Справка по использованию бота (Для режима ввода командами)\n\n" \
                 ...
                 f"ID - Идентификатор можно узнать, посмотрев список всех сотрудников (/users), где идентификатор - ID\n" \
                 ...
                 f"Внимание, имя и фамилия автоматичеки транслитерируются, а также, порядок имени и фамилии важен!\n\n" \
                 ...
                 f"Включает режим редактирования пользователя. Следуйте инструкциям бота при включении этого режима.\n\n" \
